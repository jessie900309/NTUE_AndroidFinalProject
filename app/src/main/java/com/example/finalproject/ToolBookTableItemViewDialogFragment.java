...
public class ToolBookTableItemViewDialogFragment extends DialogFragment
    ...
    public static ToolBookTableItemViewDialogFragment newInstance(String contentText,String okText,String noText,int itemID) {
        ToolBookTableItemViewDialogFragment fragment = new ToolBookTableItemViewDialogFragment();
    ...
    public ToolBookTableItemViewDialogFragment.InterfaceCommunicator interfaceCommunicator;
